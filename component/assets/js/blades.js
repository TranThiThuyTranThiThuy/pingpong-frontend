document.addEventListener("DOMContentLoaded", () => {
    ...
    const categoryMap = {
        "Tất cả": { categoryId: 2, type: "" },
        "Butterfly": { categoryId: 2, type: "Butterfly" },
        "DHS": { categoryId: 2, type: "DHS" },
        "Stiga": { categoryId: 2, type: "Stiga" },
        "Yasaka": { categoryId: 2, type: "Yasaka" },
        "Donic": { categoryId: 2, type: "Donic" },
        "Nitaku": { categoryId: 2, type: "Nitaku" },
        "Andro": { categoryId: 2, type: "Andro" }
    };
